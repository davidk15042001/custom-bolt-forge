...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Industrial Fastener Manufacturer & Supplier | Xiangjinxin" },
      {
        name: "description",
        content:
          "Bolts, nuts, anchors, threaded rods, solar fasteners and drawing-based custom bolts up to M120 for distributors, OEMs and project buyers.",
      },
