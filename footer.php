...
$whatsapp_url = lulu_base_whatsapp_url();
?>
<footer class="site-footer source-site-footer">
    <div class="container">
        ...
        <div class="footer-source-meta">
            ...
            <p class="footer-source-contact">
                <?php if (lulu_base_option('email')) : ?><a href="mailto:<?php echo esc_attr(lulu_base_option('email')); ?>"><?php echo esc_html(lulu_base_option('email')); ?></a><?php endif; ?>
                <?php if (lulu_base_option('phone')) : ?><a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', (string) lulu_base_option('phone'))); ?>"><?php echo esc_html(lulu_base_option('phone')); ?></a><?php endif; ?>
            </p>
...
<div class="source-floating-actions">
    <?php if ($whatsapp_url) : ?><a class="source-floating-whatsapp" href="<?php echo esc_url($whatsapp_url); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Chat on WhatsApp', 'lulu-base'); ?>">
    ...
    <button class="source-floating-chat" type="button" data-source-chat-toggle aria-expanded="false" aria-controls="source-sales-assistant" aria-label="<?php esc_attr_e('Open sales assistant', 'lulu-base'); ?>">
...
<div id="source-sales-assistant" class="source-chat-panel" data-source-chat-panel hidden role="dialog" aria-modal="false" aria-label="<?php esc_attr_e('Sales assistant', 'lulu-base'); ?>">
    ...
    <div class="source-chat-suggestions">
        ...
        <?php if ($whatsapp_url) : ?><a href="<?php echo esc_url($whatsapp_url); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Continue on WhatsApp', 'lulu-base'); ?></a><?php endif; ?>
    </div>
</div>
<?php wp_footer(); ?>
</body>
