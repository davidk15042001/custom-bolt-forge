...
function lulu_base_customize_register($wp_customize) {
    ...
    $wp_customize->add_panel('lulu_base_panel', [
        'title'    => __('Xiangjinxin Theme Settings', 'lulu-base'),
        'priority' => 30,
    ]);
    ...
    lulu_base_customize_text($wp_customize, 'whatsapp_number', __('WhatsApp number', 'lulu-base'), 'lulu_base_identity', __('Use the international number without spaces or a plus sign.', 'lulu-base'));
    lulu_base_customize_text($wp_customize, 'whatsapp_message', __('WhatsApp opening message', 'lulu-base'), 'lulu_base_identity', '', 'sanitize_textarea_field', 'textarea');
    ...
    lulu_base_customize_text($wp_customize, 'rfq_privacy_url', __('Privacy policy URL', 'lulu-base'), 'lulu_base_rfq', __('Relative paths such as /legal/privacy are supported.', 'lulu-base'), 'lulu_base_customize_url', 'url');
