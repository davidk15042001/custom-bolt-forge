...
<?php if (lulu_base_option('topbar_enabled')) : ?><div class="source-topbar">
...
<header class="source-site-header<?php echo lulu_base_option('sticky_header') ? ' is-sticky' : ''; ?>">
    <div class="container source-header-inner">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="source-brand">
            <?php if (has_custom_logo()) : ?>
                <?php echo wp_get_attachment_image((int) get_theme_mod('custom_logo'), 'full', false, ['class' => 'source-brand-logo', 'alt' => get_bloginfo('name')]); ?>
            <?php else : ?>
        ...
        <nav class="source-desktop-nav" aria-label="<?php esc_attr_e('Primary navigation', 'lulu-base'); ?>">
            <div class="source-nav-dropdown">
                <button type="button" aria-expanded="false" aria-haspopup="true" aria-controls="source-products-menu"><?php echo esc_html($label('Products', '产品中心')); ?><span aria-hidden="true">⌄</span></button>
                <div id="source-products-menu" class="source-nav-popover">
            ...
            <div class="source-nav-dropdown">
                <button type="button" aria-expanded="false" aria-haspopup="true" aria-controls="source-industries-menu"><?php echo esc_html($label('Industries', '应用行业')); ?><span aria-hidden="true">⌄</span></button>
                <div id="source-industries-menu" class="source-nav-popover">
            ...
            <div class="source-nav-dropdown">
                <button type="button" aria-expanded="false" aria-haspopup="true" aria-controls="source-custom-menu"><?php echo esc_html($label('Custom Manufacturing', '非标定制')); ?><span aria-hidden="true">⌄</span></button>
                <div id="source-custom-menu" class="source-nav-popover">
